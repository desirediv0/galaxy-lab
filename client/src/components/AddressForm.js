...
export default function AddressForm({
  ...
  return (
    <div
      className={
        isInline
          ? "bg-yellow-50 border border-yellow-200 p-6 mb-6"
          : "bg-white shadow-sm border p-8"
      }
    >
      {isInline && (
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            onClick={onCancel}
            className="text-gray-500 hover:text-gray-700 p-2 hover:bg-white/50 transition-colors"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-3">
            <div className="flex items-center space-x-3 bg-primary/5 p-4 border border-primary/20">
              <input
                type="checkbox"
                id="isDefault"
                name="isDefault"
        ...
        <div className="flex justify-end gap-4 mt-8 pt-6 border-t border-gray-200">
          {onCancel && (
            <Button
              ...
              variant="outline"
              disabled={loading}
              className="px-6 py-3 border-2 border-gray-200 text-gray-700 hover:bg-gray-50 font-semibold"
            >
              Cancel
            </Button>
          )}
          <Button
            type="submit"
            disabled={loading}
            className="px-8 py-3 bg-primary hover:bg-primary/90 text-white font-semibold transition-all duration-200"
          >
