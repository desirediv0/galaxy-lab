...
const ProductCard = ({ product, onAddToCart, onQuickView }) => {
  ...
  return (
    <div
      key={product.id}
      className="bg-white overflow-hidden transition-all hover:shadow-xl shadow-md rounded-lg group h-full border border-gray-100"
    >
      <Link href={`/products/${product.slug}`}>
        <div className="relative h-48 md:h-64 w-full overflow-hidden">
          <Image
            ...
            alt={product.name}
            fill
            className="object-contain px-4 transition-transform duration-300 group-hover:scale-110"
          ...
          <div className="absolute top-3 right-3 z-10">
            <Button
              variant="ghost"
              size="sm"
              className={`bg-white/90 hover:bg-white shadow-md rounded-full p-2 transition-all duration-200 ${
      ...
      <div className="p-4 text-center">
        ...
        <Link href={`/products/${product.slug}`} className="hover:text-primary">
          <h3 className="font-semibold uppercase mb-2 line-clamp-2 text-sm md:text-base text-gray-800">
            {product.name}
          </h3>
        ...
        <div className="flex items-center justify-center mb-4 flex-col md:flex-row">
          {product.hasSale ? (
            <div className="flex items-center flex-col md:flex-row">
              ...
              <span className="text-gray-500 line-through text-sm md:text-base ml-2">
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            className="px-3 border-gray-300 hover:border-primary hover:bg-primary/5 hover:text-primary"
            title="Quick View"
          >
