        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative max-w-lg mx-auto mb-8">
            <Input
              ...
              className="w-full pl-10 pr-4 py-2 border-gray-300 focus:border-primary focus:ring-primary"
            />
          ...
          <div className="mt-16 bg-gray-50 p-8 text-center">
            ...
            <div className="flex justify-center gap-4">
              <a
                href="/contact"
                className="inline-flex items-center justify-center px-6 py-3 bg-primary text-white hover:bg-primary/90 transition-colors"
              >
                Contact Us
              </a>
              <a
