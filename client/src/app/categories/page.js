      ...
      <Link href={`/category/${category.slug}`}>
        <div className="bg-white overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full">
          ...
          <div className="relative h-48 w-full overflow-hidden">
            ...
            <div className="absolute top-3 right-3 bg-primary text-white px-3 py-1 text-sm font-medium">
      ...
      <div className="container mx-auto px-4 pb-16">
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <Link href="/products">
              <button className="px-6 py-3 bg-primary text-white font-medium hover:bg-primary/90 transition-colors">
                Browse All Products
              </button>
            </Link>
          </div>
