      ...
      {product.reviews && product.reviews.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-50 p-6 border border-gray-200">
            ...
            {!canReview() && (
              <div className="mt-4 p-3 bg-amber-50 border border-amber-200 text-amber-700 text-sm flex items-center">
        ...
        <div className="text-center py-12 bg-gray-50 border border-gray-200">
          ...
          {showForm && (
            <div className="max-w-lg mx-auto mt-8 p-6 bg-white border border-gray-200">
              <form onSubmit={handleReviewSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium mb-2">
                    Rating <span className="text-red-500">*</span>
