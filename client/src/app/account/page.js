              ...
              {addresses.length > 0 ? (
                <div className="grid gap-4">
                  {addresses.slice(0, 2).map((address) => (
                    <div
                      key={address.id}
                      className="border p-3 flex justify-between items-start"
                    >
                      <div>
                        {address.isDefault && (
                          <span className="inline-block text-xs bg-primary/10 text-primary px-2 py-0.5 mb-2">
                            Default
                          </span>
                        )}
                ...
                <div className="text-center py-6 border">
                  <DynamicIcon
                    name="MapPin"
