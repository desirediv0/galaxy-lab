              ...
              <div className="bg-white shadow p-6">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4">
                  ...
                  <div className="mt-3 sm:mt-0">
                    <span
                      className={`px-3 py-1 inline-flex text-sm font-semibold ${getStatusColor(
                        order.status
                      )}`}
                    >
                      {order.status}
                    ...
                    <div className="space-y-2">
                      <div className="flex flex-col sm:flex-row sm:justify-between">
                        ...
                        <div className="text-sm">
                          ...
                          <span
                            className={`px-2 py-0.5 inline-flex text-xs font-semibold ${getStatusColor(
                  ...
                  {order.items.map((item) => (
                    ...
                    >
                      <Link
                        ...
                        className="w-20 h-20 flex-shrink-0 bg-gray-100 overflow-hidden mr-4"
                      >
                        {item.image ? (
                          <Image
                            width={80}
                        ...
                        <div className="text-sm text-gray-600 space-y-1">
                          {(item.flavor || item.weight) && (
                            <p className="text-sm">
                              ...
                              {item.flavor && item.weight && <span> • </span>}
                              {item.weight && (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white shadow p-6">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {order.couponCode && (
                    <div className="mt-1 p-2 bg-green-50 border border-green-100">
