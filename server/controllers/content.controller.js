  ...
  try {
    ...
    if (faqs.length > 0) {
      return res.status(200).json(
        new ApiResponsive(200, {
          faqs,
          metaTitle: "Frequently Asked Questions | GalaxyLabs",
          metaDescription:
  ...
  try {
    ...
    if (contactContent) {
      const contactData = {
        ...
        socialLinks: {
          facebook: "https://facebook.com/GalaxyLabs",
          instagram: "https://instagram.com/GalaxyLabs",
          twitter: "https://twitter.com/GalaxyLabs",
        },
      };
    ...
    const contactInfo = {
      ...
      metaTitle: "Contact Us | GalaxyLabs",
      metaDescription:
